...
function LiveSession({ selectedSession, setSelectedSession }: {
  ...
  return (
    <>
      ...
      <div className="flex-1 flex flex-col">
          ...
          <div className="flex-1 rounded overflow-hidden relative" style={{ backgroundColor: 'var(--video-bg)' }}>
            <div className="w-full h-full relative">
              ...
              <canvas
                ...
                className="absolute inset-0 w-full h-full z-10 transition-transform duration-75"
                style={{ 
                  cursor: activeTool === 'arrow' ? 'default' : 'crosshair', 
                  pointerEvents: activeTool === 'arrow' ? 'none' : 'auto',
                  transform: `translate(${trackingOffset.xPct}%, ${trackingOffset.yPct}%)`
                }}
              />
              ...
              {/* Bottom-right HUD - Recording timer */}
              {isRecording && (
        ...
        <div className="border-t border-border px-4 py-3 flex items-center gap-3">
          ...
          <div className="flex items-center gap-1 flex-1">
            <button className="px-3 h-9 rounded border border-border hover:bg-accent transition-colors text-sm">
              Freeze Frame
            </button>
            <button className="px-3 h-9 rounded border border-border hover:bg-accent transition-colors text-sm">
              Laser Pointer
      ...
      {/* Right Panel */}
      <div className="w-56 border-l border-border flex flex-col overflow-y-auto bg-card">
        {/* Session KPIs */}
        <div className="p-4 border-b border-border">
          <div className="text-xs uppercase tracking-wide text-muted-foreground mb-3">Session KPIs</div>
          <div className="grid grid-cols-2 gap-2">
            <div className="p-2 rounded border border-border bg-background">
              <div className="text-xs text-muted-foreground">Latency</div>
              <div className="text-lg font-mono mt-1">42ms</div>
            </div>
            <div className="p-2 rounded border border-border bg-background">
              <div className="text-xs text-muted-foreground">Duration</div>
              <div className="text-lg font-mono mt-1">14:23</div>
            </div>
            <div className="p-2 rounded border border-border bg-background">
              <div className="text-xs text-muted-foreground">Annotations</div>
              <div className="text-lg font-mono mt-1">37</div>
            </div>
            <div className="p-2 rounded border border-border bg-background">
              <div className="text-xs text-muted-foreground">Packet Loss</div>
              <div className="text-lg font-mono mt-1">0.2%</div>
            </div>
          </div>
        </div>
        ...
        {/* Network Health */}
        <div className="p-4 border-b border-border">
          <div className="text-xs uppercase tracking-wide text-muted-foreground mb-3">Network Health</div>
          <div className="space-y-3">
            <div>
              <div className="flex justify-between text-xs mb-1">
                <span>Video</span>
                <span className="font-mono text-[var(--status-online)]">38ms</span>
              </div>
            ...
            <div>
              <div className="flex justify-between text-xs mb-1">
                ...
                <span className="font-mono text-[var(--status-online)]">12ms</span>
              </div>
              <div className="h-1.5 bg-secondary rounded-full overflow-hidden">
            ...
            <div>
              <div className="flex justify-between text-xs mb-1">
                <span>Jitter</span>
                <span className="font-mono text-[var(--status-online)]">3ms</span>
              </div>
              <div className="h-1.5 bg-secondary rounded-full overflow-hidden">
